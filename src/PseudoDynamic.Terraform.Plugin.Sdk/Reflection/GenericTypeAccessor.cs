...
namespace PseudoDynamic.Terraform.Plugin.Reflection
{
    internal class GenericTypeAccessor
    {
        ...
        private readonly ConcurrentDictionary<Type, TypeAccessor> _typeAccessorByTypeArgument = new();
        private readonly ConcurrentDictionary<Type[], TypeAccessor> _typeAccessorByTwoTypeArgument = new();
