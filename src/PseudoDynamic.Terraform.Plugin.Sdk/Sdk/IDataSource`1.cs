...
{
    public interface IDataSource<Schema> : IDataSource where Schema : class
    {
        internal new static readonly ProviderAdapter.DataSourceAdapter<Schema> DataSourceAdapter;
