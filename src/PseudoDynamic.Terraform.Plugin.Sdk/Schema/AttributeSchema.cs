...
namespace PseudoDynamic.Terraform.Plugin.Schema
{
    ...
    public record AttributeSchema
    {
        ...
        /// </summary>
        public TerraformType TerraformType => AttributeTypeInfo.TerraformType;
        ...
        internal AttributeSchema(string attributeName, BlockSchemaPropertyInfo attributeTypeInfo)
        {
